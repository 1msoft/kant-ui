...
// urlList普通图片URL数组
const urlList = [
  { url: "http://pic2.orsoon.com/2017/0302/20170302052418236.jpg" },
  { url: "http://pic2.orsoon.com/2017/0302/20170302052417306.jpg" },
  { url: "http://pic2.orsoon.com/2017/0302/20170302052419961.jpg" },
  { url: "http://pic2.orsoon.com/2017/0302/20170302052420498.jpg" }
];
...
// 长图 1000*3423
const longImg = [
  { url: "http://img.redocn.com/sheji/20150207/xiaofanganquanzhishizhanban_3928817.jpg" }
];

// 宽图 3867*1563
const wideImg = [
  { url: "http://news.mydrivers.com/img/20180907/6f0414ea92074d24be74dc82fda19479.jpg" }
];
...
describe('ImagePreviewer', () => {
  ...
  it('点击关闭是否正常处理', () => {
    ...
    wrapper.find('.em-image-previewer-quit').simulate('click');
    wrapper.update();
